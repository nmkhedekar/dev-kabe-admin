...
import {SyncStockAction,SyncStockActionNull} from "../../../action";
...
export default function DescriptionTab() {
	...
	const synchronization = syncAuth.syncStock;


	const syncDescription=()=>{
		const data = {username:username,password:password,dateTime:dateTime}
		dispatch(SyncStockAction(data))
	}

	useEffect(()=>{
		dispatch(SyncStockActionNull())
	},[])
	return (
		<div>
