            ...
            <div className="col-md-3"> 
              ...
              <div className="box box-primary">
                <div className="">
                  ...
                  <div className="row">
                    <ul className="col-sm-8 imgFlex">
                   {/* {product[0]?.stocks?.pic.map((dt)=>(
                      <li><img src={dt} height="40" width="40"/></li>
                      ))} */}
                    </ul>
                    </div>
                  </h3>
